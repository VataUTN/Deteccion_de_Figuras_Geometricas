...
class App:
    ...
    def __init__(self):
        ...
        logo = self.leer_imagen("UI/logo.png", (200, 200))          # leo el logo con la funcion leer_imagen.
    ...
    def reconoceFigura(self, contenedor_abajo):
        ...
        if reconoce == True:
            ...
            self.figura = tk.Label(contenedor_abajo, text="Nombre de la figura", font=('Arial', 20), fg="black",
